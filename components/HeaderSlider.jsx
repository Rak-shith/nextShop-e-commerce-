...
const HeaderSlider = () => {
  const sliderData = [
    {
      id: 1,
      title: "Experience Pure Cotton-Elastic Hoodie - Your Perfect collection Awaits!",
      offer: "Limited Time Offer 30% Off",
      buttonText1: "Buy now",
      buttonText2: "Find more",
      imgSrc: "/images/black_hoodie_mockup.png",
    },
    {
      id: 2,
    ...
    <div className="overflow-hidden relative w-full">
      ...
      >
        {sliderData.map((slide, index) => (
          <div
            key={slide.id}
            className="flex flex-col-reverse md:flex-row items-center justify-between dark:bg-grayDark py-8 md:px-14 px-5 mt-6 rounded-xl min-w-full"
          >
